...
dependencies {
    if (useLocalDependencies) {
        ...
        compileOnly(files("$bossPluginApiPath/build/libs/boss-plugin-api-1.0.72.jar"))
        testImplementation(files("$bossPluginApiPath/build/libs/boss-plugin-api-1.0.72.jar"))
    } else {
