...
**Fluck Browser** (`ai.rever.boss.plugin.dynamic.fluckbrowser`) is a dynamic plugin for the BOSS desktop application.

Full-featured embedded web browser tab with zoom controls, loading indicator, and security indicator

- **Plugin ID**: `ai.rever.boss.plugin.dynamic.fluckbrowser`
- **Main Class**: `ai.rever.boss.plugin.dynamic.fluckbrowser.FluckBrowserDynamicPlugin`
- **API Version**: 1.0.20
